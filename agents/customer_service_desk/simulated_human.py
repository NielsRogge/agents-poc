...
simulated_human_agent = Agent(
    name="simulated_human",
    public_description="Placeholder, simulated human agent that can provide more advanced help to the user. Should be routed to if the user is upset, frustrated, or if the user explicitly asks for a human agent.",
    instructions="""
